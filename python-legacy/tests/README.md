...
| Script | Purpose |
|--------|---------|
| `../diagnostics/diagnostic.py` | Proof-of-life: load the model on the auto-detected device (CUDA / MPS / CPU) and transcribe bundled ATC snippets |
...
`diagnostics/diagnostic.py` is a quick handshake that confirms the fine-tuned
