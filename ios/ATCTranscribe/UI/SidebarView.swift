...
/// link is enabled (settings bar / Settings); muted otherwise. Auto-added to the sidebar when the
    ...
    var body: some View {
        ...
        Card(title: "Stratux link") {
            VStack(alignment: .leading, spacing: 8) {
                ...
                if !active {
                    Text("Turn on the Stratux link in the settings bar. Pick “Stratux receiver” as the input source to transcribe its audio.")
