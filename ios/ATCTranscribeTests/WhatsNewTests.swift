...
final class WhatsNewTests: XCTestCase {
    ...
    func testConcreteChangelogContract() {
        XCTAssertEqual(builds, [63, 62, 61, 60, 59, 58, 57, 56, 55, 54, 53, 51, 49, 47, 46, 45, 44, 43, 42, 41, 40, 39, 38, 37, 36, 35, 34, 33, 31, 30, 29, 28, 27, 26, 25, 24, 23, 22, 21, 18, 17, 16, 15, 14, 13, 12, 11, 10, 8], "the shipped build list changed — update the gate tests")
        XCTAssertEqual(WhatsNew.releaseNotes.first?.build, 63)
