...
final class WhatsNewTests: XCTestCase {
    ...
    func testConcreteChangelogContract() {
        XCTAssertEqual(builds, [31, 30, 29, 28, 27, 26, 25, 24, 23, 22, 21, 18, 17, 16, 15, 14, 13, 12, 11, 10, 8], "the shipped build list changed — update the gate tests")
        XCTAssertEqual(WhatsNew.releaseNotes.first?.build, 31)
